PulsarStore.Language:Language("tr", 1)
    ...
    :Set("error.maxconvert", "Günlük {{credits}} kredi dönüştürme limitine ulaştınız. Bugün {{allowed}} daha fazla kredi dönüştürebilirsiniz!")
    ...
    :Set("success.convert.money.left", "${{arg1}}'ı {{arg2}} krediye dönüştürdünüz. Bugün {{allowed}} daha fazla kredi dönüştürebilirsiniz!")
